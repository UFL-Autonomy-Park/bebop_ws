...
: ${AMENT_CURRENT_PREFIX:="/home/max/bebop_ws/install/bebop_server"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bebop_server/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bebop_server/environment/path.sh"
